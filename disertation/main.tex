...
% Find some examples of SCA where they do not recover keys
The main goal of Side-Channel Attacks is to recover the secret key. Side-Channel Attacks have also been used to 

% paragraph about Kocher's attacks and what he broke
% Kocher the first - timing, followed by power analysis 3 years later
...
% Sentence about the attacks overall, requirements ?
