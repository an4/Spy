\contentsline {lstlisting}{\numberline {3.1}Example JavaScript timing code as shown in \cite {bortz2007exposing}}{16}
\contentsline {lstlisting}{\numberline {4.1}Code for comparing access times from RAM vs Cache}{24}
\contentsline {lstlisting}{\numberline {4.2}Measuring the load time of an external resource as an Image}{28}
