...
\begin{itemize}
\item A web page which lets user generate graphs in order to determine how easy it is to distinguish between files of different size using either the Video or the Image methods which can be seen in Figure \ref{fig:videointerface}.
...
%why we need mutiple and how to get them, two methods + promises
