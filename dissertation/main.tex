...
The idea of using cache memory as a side-channel was first proposed by Kelsey et al. in \cite{kelsey1998side}. The suggestion was later used by Page who described a theoretical attack against DES in \cite{page2002theoretical}. 
...
\section{Osvik et al. - Cache Attacks and Countermeasures: The Case of AES}
