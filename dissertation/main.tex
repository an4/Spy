...
To conclude, browser attacks are an important class of side-channel attacks which pose an imminent threat to the privacy of online users. Most of these attacks are possible due to browser software using a wide range of third-party resources in order to provide richer, more interactive and dynamic web pages. 
