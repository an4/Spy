...
Van Goethem et al. present several new methods of measuring the load time of an external resources and compares them to existing attacks. Their methods seems to outperform previous attacks in both speed and reliability. They also give several example of how this attacks can be used to obtain information about a user and discuss possible countermeasures \cite{van2015clock}.
