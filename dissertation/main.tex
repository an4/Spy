...
The back-end script contains various functions for measuring the time of loading an external resource into an Image element or a Video element. The basic building block are the two algorithm depicted in Listing \ref{vanvideo} for measuring the load time of a file using the Video elements and in Listing \ref{vanimage} which measures the load time of an external resource using the Image element.
