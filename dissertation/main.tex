...
The attack discovered by Van Goethem et al.\cite{van2015clock} and presented in Section \ref{van} uses relatively new technologies as source of leakage. 
...
%overall conclusion par, affects lots of people, still possible, new attack vectors
