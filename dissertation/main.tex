...
Oren et al.\cite{oren2015spy} present an attack written in JavaScript, which runs entirely in the browser. Their attack uses the PRIME+PROBE algorithm, which was previously used to recover the secret parameters in AES\cite{pub2001197}, in order to disclose the state of the victim's cache memory. The attack described by Oren et al.\cite{oren2015spy} tracks the user's behaviour.
